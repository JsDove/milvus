...
require (
	...
	github.com/zilliztech/woodpecker v0.1.2 // indirect
...
replace (
	...
	github.com/milvus-io/milvus-proto/go-api/v2 => github.com/JsDove/milvus-proto/go-api/v2 v2.0.0-20250804035908-1dbbfba31e3d
