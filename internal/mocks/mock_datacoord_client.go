...
func (_m *MockDataCoordClient) Watch(ctx context.Context, in *datapb.WatchRequest, opts ...grpc.CallOption) (datapb.DataCoord_WatchClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 datapb.DataCoord_WatchClient
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.WatchRequest, ...grpc.CallOption) (datapb.DataCoord_WatchClient, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *datapb.WatchRequest, ...grpc.CallOption) datapb.DataCoord_WatchClient); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(datapb.DataCoord_WatchClient)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *datapb.WatchRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockDataCoordClient_Watch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Watch'
type MockDataCoordClient_Watch_Call struct {
	*mock.Call
}

// Watch is a helper method to define mock.On call
//   - ctx context.Context
//   - in *datapb.WatchRequest
//   - opts ...grpc.CallOption
func (_e *MockDataCoordClient_Expecter) Watch(ctx interface{}, in interface{}, opts ...interface{}) *MockDataCoordClient_Watch_Call {
	return &MockDataCoordClient_Watch_Call{Call: _e.mock.On("Watch",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockDataCoordClient_Watch_Call) Run(run func(ctx context.Context, in *datapb.WatchRequest, opts ...grpc.CallOption)) *MockDataCoordClient_Watch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*datapb.WatchRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockDataCoordClient_Watch_Call) Return(_a0 datapb.DataCoord_WatchClient, _a1 error) *MockDataCoordClient_Watch_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDataCoordClient_Watch_Call) RunAndReturn(run func(context.Context, *datapb.WatchRequest, ...grpc.CallOption) (datapb.DataCoord_WatchClient, error)) *MockDataCoordClient_Watch_Call {
	_c.Call.Return(run)
	return _c
}
