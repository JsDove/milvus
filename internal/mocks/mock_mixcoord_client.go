...
func (_m *MockMixCoordClient) Watch(ctx context.Context, in *datapb.WatchRequest, opts ...grpc.CallOption) (datapb.DataCoord_WatchClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockMixCoordClient_Watch_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Watch'
type MockMixCoordClient_Watch_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockMixCoordClient_Expecter) Watch(ctx interface{}, in interface{}, opts ...interface{}) *MockMixCoordClient_Watch_Call {
	return &MockMixCoordClient_Watch_Call{Call: _e.mock.On("Watch",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockMixCoordClient_Watch_Call) Run(run func(ctx context.Context, in *datapb.WatchRequest, opts ...grpc.CallOption)) *MockMixCoordClient_Watch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockMixCoordClient_Watch_Call) Return(_a0 datapb.DataCoord_WatchClient, _a1 error) *MockMixCoordClient_Watch_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMixCoordClient_Watch_Call) RunAndReturn(run func(context.Context, *datapb.WatchRequest, ...grpc.CallOption) (datapb.DataCoord_WatchClient, error)) *MockMixCoordClient_Watch_Call {
	_c.Call.Return(run)
	return _c
}
